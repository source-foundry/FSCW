...
;    Hack Bold
;    Hack-Bold-DEV.ttf
;    C:\dev\git\fscw\fonts\Hack-Bold-DEV.ttf
;    f2d934950260ababafc9749437c9c3920535cd03

;  INI position #2
;    Hack
;    Hack-Regular-DEV.ttf
;    C:\dev\git\fscw\fonts\Hack-Regular-DEV.ttf
;    72bfdada8c04aa5b29dc48f79c1450aaaa60215b

;  INI position #3
;    Hack Bold Italic
;    Hack-BoldItalic-DEV.ttf
;    C:\dev\git\fscw\fonts\Hack-BoldItalic-DEV.ttf
;    49eb13ffe0b7faf879cd3c22ef77e8e9bfd4f5cf

;  INI position #4
;    Hack Italic
;    Hack-Italic-DEV.ttf
;    C:\dev\git\fscw\fonts\Hack-Italic-DEV.ttf
;    de906ef34e0c3adadd6df8b41ae63383d54c62f2
...
;  INI position #1
;    Hack-BoldOblique-DEV.ttf
;    Hack Bold Oblique

;  INI position #2
;    Hack-RegularOblique-DEV.ttf
;    Hack Oblique

;  INI position #3
;    Hack-BoldOblique-DEV.otf
;    Hack Bold Oblique

;  INI position #4
;    Hack-RegularOblique-DEV.otf
;    Hack Oblique
...
; C:\dev\git\fscw\fonts\Hack-Bold-DEV.ttf\Hack-Bold-DEV.ttf - "Hack Bold" - f2d934950260ababafc9749437c9c3920535cd03
; C:\dev\git\fscw\fonts\Hack-Regular-DEV.ttf\Hack-Regular-DEV.ttf - "Hack" - 72bfdada8c04aa5b29dc48f79c1450aaaa60215b
; C:\dev\git\fscw\fonts\Hack-BoldItalic-DEV.ttf\Hack-BoldItalic-DEV.ttf - "Hack Bold Italic" - 49eb13ffe0b7faf879cd3c22ef77e8e9bfd4f5cf
; C:\dev\git\fscw\fonts\Hack-Italic-DEV.ttf\Hack-Italic-DEV.ttf - "Hack Italic" - de906ef34e0c3adadd6df8b41ae63383d54c62f2
...
AppComments=Ten Gallon Hat fonts v1.02
...
DirExistsWarning=no
 ...
 SetupIconFile=src\Hack-installer-icon.ico
...
ReadyLabel2b=Setup is now ready to install the Ten Gallon Hat fonts v1.02 on your system.
...
[Files]
  ...
  Source: "src\Hack-installer-icon.ico"; DestDir: "{app}"; Flags: ignoreversion;

;------------------------
;Install font files and register them
  Source: "C:\dev\git\fscw\fonts\Hack-Bold-DEV.ttf"; FontInstall: "Hack Bold"; DestDir: "{fonts}"; Check: FontFileInstallationRequired; Flags: ignoreversion restartreplace; 
  Source: "C:\dev\git\fscw\fonts\Hack-Regular-DEV.ttf"; FontInstall: "Hack"; DestDir: "{fonts}"; Check: FontFileInstallationRequired; Flags: ignoreversion restartreplace; 
  Source: "C:\dev\git\fscw\fonts\Hack-BoldItalic-DEV.ttf"; FontInstall: "Hack Bold Italic"; DestDir: "{fonts}"; Check: FontFileInstallationRequired; Flags: ignoreversion restartreplace; 
  Source: "C:\dev\git\fscw\fonts\Hack-Italic-DEV.ttf"; FontInstall: "Hack Italic"; DestDir: "{fonts}"; Check: FontFileInstallationRequired; Flags: ignoreversion restartreplace; 
;------------------------
...
;These "ghost" files need to be exterminated!
  Type: files; Name: "{fonts}\Hack-Bold-DEV_*.ttf"; 
  Type: files; Name: "{fonts}\Hack-Regular-DEV_*.ttf"; 
  Type: files; Name: "{fonts}\Hack-BoldItalic-DEV_*.ttf"; 
  Type: files; Name: "{fonts}\Hack-Italic-DEV_*.ttf"; 
;------------------------

;------------------------
;Remove old font files during install
  Type: files; Name: "{fonts}\Hack-BoldOblique-DEV.ttf"; 
  Type: files; Name: "{fonts}\Hack-RegularOblique-DEV.ttf"; 
  Type: files; Name: "{fonts}\Hack-BoldOblique-DEV.otf"; 
...
begin
  ...
  AddFontData('Hack-Bold-DEV.ttf', 'Hack Bold', 'f2d934950260ababafc9749437c9c3920535cd03');
  AddFontData('Hack-Regular-DEV.ttf', 'Hack', '72bfdada8c04aa5b29dc48f79c1450aaaa60215b');
  AddFontData('Hack-BoldItalic-DEV.ttf', 'Hack Bold Italic', '49eb13ffe0b7faf879cd3c22ef77e8e9bfd4f5cf');
  AddFontData('Hack-Italic-DEV.ttf', 'Hack Italic', 'de906ef34e0c3adadd6df8b41ae63383d54c62f2');
